...
> The CyberSecurity Framework (CSF for short) is a local Python3 scripting package, where you can execute and create new programs for **any purpuse that go under your own responsibility** to fit your needs.
> 
